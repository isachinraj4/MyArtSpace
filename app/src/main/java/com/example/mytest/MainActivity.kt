...
//            Toast.makeText(LocalContext.current,"True",Toast.LENGTH_SHORT).show()
//        }
//        else{
//
//        }
        ...
        Row(
            ...
            Button(onClick = { clicks += 1 }) {
                ...
                if(selectedOption == word) {
                    ...
                    Toast.makeText(LocalContext.current,"False",Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
...
//fun nextClick(clicks: Int, selectedOption: String):Int {
//
//}
